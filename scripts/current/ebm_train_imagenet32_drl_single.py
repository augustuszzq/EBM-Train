#!/usr/bin/env python3
"""DRL-backbone wrapper for single-GPU full-K and serial pipeline emulation."""

from __future__ import annotations

try:
    import ebm_train_single_pipe_emul as _trainer
    ...
    from polaris_ebm.scripts.current import ebm_train_single_pipe_emul as _trainer
