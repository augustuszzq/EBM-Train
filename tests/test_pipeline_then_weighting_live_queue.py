...
from polaris_ebm.scripts.current.pipeline_then_weighting_live_queue import (
    build_specs,
...
def test_build_specs_keeps_only_submitted_e1_rows(tmp_path):
    rows = [
        {
            "phase": "E1",
            "submit": "yes",
...
def test_launchable_specs_requires_checkpoint_and_incomplete_progress(tmp_path):
    ...
    assert launchable[0]["exp_id"] == "E1_a"
